<template>
    <div id="error">
        <nav class="shelf">
            <a class="book home-page">Not Found</a>
            <a class="book about-us">Not Found</a>
            <a class="book contact">Not Found</a>
            <a class="book faq">Not Found</a>
        ...
        <p style="text-align: center">糟糕，您要找的书籍不在书架中。。。</p>
    </div>
</template>
